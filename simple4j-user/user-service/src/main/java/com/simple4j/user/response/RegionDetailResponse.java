...
public class RegionDetailResponse implements INode<RegionDetailResponse, String> {
	...
	@ApiModelProperty(name = "has_children", value = "是否有子节点")
	...
	@Override
	public void addChildren(com.simple4j.user.response.RegionDetailResponse children) {
	...
	@Override
	public int compareTo(com.simple4j.user.response.RegionDetailResponse o) {
