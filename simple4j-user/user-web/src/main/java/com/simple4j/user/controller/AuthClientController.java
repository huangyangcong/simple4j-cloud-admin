...
public class AuthClientController {
	...
	public ApiResponse<ClientDetailResponse> detail(@Valid @RequestBody ClientDetailRequest clientDetailRequest) {
	...
	public ApiResponse<Page<ClientDetailResponse>> list(@Valid @RequestBody ClientPageRequest clientPageRequest) {
	...
	public ApiResponse save(@Valid @RequestBody ClientAddRequest clientAddRequest) {
	...
	public ApiResponse update(@Valid @RequestBody ClientUpdateRequest clientUpdateRequest) {
	...
	public ApiResponse submit(@Valid @RequestBody ClientAddOrUpdateRequest clientAddOrUpdateRequest) {
	...
	public ApiResponse remove(@Valid @RequestBody ClientRemoveRequest clientRemoveRequest) {
