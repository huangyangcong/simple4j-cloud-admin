...
import com.ruoyi.flowable.common.cmd.BackUserTaskCmd;
import com.ruoyi.flowable.common.exception.FlowableNoPermissionException;
import com.ruoyi.flowable.constant.FlowableConstant;
import com.ruoyi.flowable.service.FlowableTaskService;
import com.ruoyi.flowable.util.FlowableUtils;
import com.ruoyi.flowable.vo.*;
...
public class FlowableTaskServiceImpl implements FlowableTaskService {
    ...
    public void completeTask(TaskRequest taskRequest) {
        String taskId = taskRequest.getTaskId();
        String currUserId = String.valueOf(SecurityUtils.getLoginUser().getUser().getUserId());
        Task task = getTaskNotNull(taskId);
    ...
    public List<FlowNodeResponse> getBackNodes(String taskId) {
        TaskEntity taskEntity = (TaskEntity) permissionService.validateExcutePermissionOnTask(taskId,
                String.valueOf(SecurityUtils.getLoginUser().getUser().getUserId()));
