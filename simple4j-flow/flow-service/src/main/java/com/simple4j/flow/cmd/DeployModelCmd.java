...
public class DeployModelCmd implements Command<Deployment>, Serializable {
    ...
    public DeployModelCmd(String modelId, FlowableFormMapper flowableFormMapper) {
        this.modelId = modelId;
        this.flowableFormMapper = flowableFormMapper;
    }
            ...
            for (FlowElement flowElement : flowElements) {
                ...
                if (formKey != null && formKey.length() > 0) {
                    if (formKeyMap.containsKey(formKey)) {
                        ...
                        FlowableForm form = flowableFormMapper.selectById(formKeyDefinition);
