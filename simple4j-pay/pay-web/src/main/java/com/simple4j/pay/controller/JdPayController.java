...
public class JdPayController {
	...
	public ApiResponse appPay() {
		...
		if (!"000000".equals(code)) {
			...
			return ApiResponse.businessEx(desc);
		}
		// 解密并验证签名
		...
		return ApiResponse.ok(new AppParams(orderId, jdPayBean.getMchId(), "123456789",
			sign, "123456789"));
	}
...
//                .amount("1000")
	...
	@ResponseBody
	public ApiResponse queryOrder(@RequestParam("tradeType") String tradeType,
		...
		return ApiResponse.ok(decrypt);
	}

	@RequestMapping(value = "/fkmPay", method = {RequestMethod.POST, RequestMethod.GET})
	@ResponseBody
	public ApiResponse fkmPay(@RequestParam("token") String token,
	...
	@ResponseBody
	public ApiResponse userRelation(@RequestParam("userId") String userId,
	...
	@ResponseBody
	public ApiResponse refund(@RequestParam("amount") String amount,
							  @RequestParam("oTradeNum") String oTradeNum,
							  @RequestParam("tradeNum") String tradeNum) {
	...
	@ResponseBody
	public ApiResponse queryBaiTiaoFq(@RequestParam("amount") String amount) {
