...
public class TableInfo {
	...
	private String entityFirstLowerCase;
	private String entityAddOrUpdateRequest;
	private String entityAddRequest;
	private String entityUpdateRequest;
	private String entityDetailRequest;
	private String entityTreeRequest;
	private String entityRemoveRequest;
	private String entityPageRequest;
	private String entityListRequest;
	private String entityDetailResponse;
	...
	protected TableInfo setConvert(StrategyConfig strategyConfig) {
		if (strategyConfig.startsWithTablePrefix(name)
		...
		if (CollectionUtils.isNotEmpty(fields)) {
			...
			for (TableField field : fields) {
				...
				if (field.isKeyFlag()) {
					...
					// 普通字段
					importPackages.add(
						com.baomidou.mybatisplus.annotation.TableField.class.getCanonicalName());
				}
				if (null != field.getFill()) {
					...
					importPackages.add(
						com.baomidou.mybatisplus.annotation.TableField.class.getCanonicalName());
					importPackages.add(
						com.baomidou.mybatisplus.annotation.FieldFill.class.getCanonicalName());
				}
			}
		}
		return this;
	...
	public String getFieldNames() {
		if (StringUtils.isBlank(fieldNames) && CollectionUtils.isNotEmpty(fields)) {
