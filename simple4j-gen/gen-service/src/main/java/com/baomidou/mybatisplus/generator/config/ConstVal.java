...
public interface ConstVal {
	...
	String ADD_OR_UPDATE_REQUEST = "AddOrUpdateRequest";
	String ADD_REQUEST = "AddRequest";
	String UPDATE_REQUEST = "UpdateRequest";
	String PAGE_REQUEST = "PageRequest";
	String REMOVE_REQUEST = "RemoveRequest";
	String LIST_REQUEST = "ListRequest";
	String TREE_REQUEST = "TreeRequest";
	String DETAIL_REQUEST = "DetailRequest";
	String DETAIL_RESPONSE = "DetailResponse";
