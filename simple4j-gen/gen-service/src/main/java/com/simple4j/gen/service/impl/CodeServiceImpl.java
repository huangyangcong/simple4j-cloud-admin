...
@RequiredArgsConstructor
	...
	public Page<CodeDetailResponse>page(CodePageRequest codePageRequest){
		LambdaQueryWrapper<Code>queryWrapper = Wrappers.<Code>lambdaQuery();
		IPage<Code> page = codeMapper.page(new com.baomidou.mybatisplus.extension.plugins.pagination.Page<>(codePageRequest.getPageNo(), codePageRequest.getPageSize()),queryWrapper);
		Page<Code> pages = new Page<>(page.getCurrent(), page.getSize(), page.getTotal(), page.getRecords());
