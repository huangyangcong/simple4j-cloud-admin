...
public class DynamicSecurityServiceImpl implements DynamicSecurityService {
	...
	@Override
	public void loadDataSource(ExpressionUrlAuthorizationConfigurer.ExpressionInterceptUrlRegistry registry, DefaultWebSecurityExpressionHandler expressionHandler) {
		registry.mvcMatchers(HttpMethod.POST, "/user/api/v1/info").authenticated();
	}
