...
public class PostServiceImpl implements IPostService {
  ...
  public PostDetailResponse detail(PostDetailRequest postDetailRequest) {
    Post detail =
        postMapper.getOne(Wrappers.<Post>lambdaQuery().eq(Post::getId, postDetailRequest.getId()));
    PostDetailResponse postDetailResponse = postMapStruct.toVo(detail);
    String categoryName = dictService.getValue("post_category", postDetailResponse.getCategory());
