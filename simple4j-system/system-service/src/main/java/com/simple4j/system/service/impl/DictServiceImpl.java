...
public class DictServiceImpl implements IDictService {
  ...
  public DictDetailResponse detail(DictDetailRequest dictDetailRequest) {
    Dict detail =
        dictMapper.getOne(Wrappers.<Dict>lambdaQuery().eq(Dict::getId, dictDetailRequest.getId()));
  ...
  public Page<DictDetailResponse> page(DictPageRequest dictPageRequest) {
    LambdaQueryWrapper<Dict> queryWrapper = Wrappers.<Dict>lambdaQuery().orderByAsc(Dict::getSort);
    IPage<Dict> page =
        dictMapper.page(
